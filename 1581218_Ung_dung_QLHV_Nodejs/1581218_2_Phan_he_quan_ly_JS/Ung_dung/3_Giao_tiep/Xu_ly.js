...
//             } //Giao tiep voi du lieu phan he sinh vien
//             else if (Ma_so_Xu_ly == "Cap_nhat_don_xin_nghi_phep") {
//                 var Doi_tuong=JSON.parse(Chuoi_Nhan)
//                 Cap_nhat_doi_tuong(Doi_tuong,"SINH_VIEN")    
...
//   return Danh_sach
// }
// // function Cap_nhat_doi_tuong(Doi_tuong,Loai_Doi_tuong){
// //   var Duong_dan = "..//..//" + Thu_muc_Du_lieu + "//" + Loai_Doi_tuong 
...
// // }
// function Cap_nhat_doi_tuong(Doi_tuong,Loai_Doi_tuong){
//     var Duong_dan = "../../../1581218_2_Phan_he_quan_ly_JS/Ung_dung/1_Giao_dien/MH_Quan_ly.html"
//     var Chuoi=JSON.stringify (Doi_tuong)     
//     XL_File.writeFileSync(Duong_dan , Chuoi,"UTF-8")   

//     $.ajax({
//         type: "POST",
//         url: "../../../1581218_2_Phan_he_quan_ly_JS/Ung_dung/1_Giao_dien/MH_Quan_ly.html",
//         data: Chuoi,
//         dataType: "json",
